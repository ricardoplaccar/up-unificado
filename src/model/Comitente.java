...
public class Comitente {
	...
	private String[] nomes = { "Bradesco", "Itaú", "Banco PAN", "Santander", "Sicred", "Tribunal de Justiça", "Banco do Brasil",
			"Localiza", "Porto Seguro", "Maravilhas -SC" };
	private String[] logos = { "bradesco-card.jpg", "banco-itau-card.jpg", "logo-banco-pan-4096.jpg",
			"santander-card-new.jpg", "sicred.jpg", "leilao-tsj.jpg", "bb.jpg", "localiza.jpg",
			"leilao-porto-seguro-card.jpg", "maravilhas-sc.jpg"};
	private String[] urls = {
			...
			"https://www49.bb.com.br/m/simular-credito-veiculo"
			
	};

	private String Caminho = "D:\\ricsistemas\\Documents\\Placar\\fotos\\logos\\";

	public Comitente(int num) {

		Id = num;
		Nome = nomes[num];
		logo = Caminho + logos[num];
		UrlFinaceira = urls[num];

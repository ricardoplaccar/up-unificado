...
public class Veiculo {
	...
	public Veiculo(String marca, String modelo, String ano, String combustivel, String cor, String km, String valor, String lance,String incremento, 
...
//**************** Veículo 0 ***********************************************
		...
		ListaVeiculos.add(new Veiculo("Audi", "R8 Spyder 5.2 Quattro R-tronic/S-tronic", "2012", "Flex", "Branca",
		...
		ListaVeiculos.add(new Veiculo("Bmw", "740iA", "2000", "Flex", "Prata", "60000", "4400000","40000","5000",
		...
		ListaVeiculos.add(new Veiculo("Chevrolet", "Chevette L / SL / SL/e / DL / SE 1.6", "1993", "Gasolina", "Prata",
		...
		ListaVeiculos
				.add(new Veiculo("Fiat", "AR DRIVE S-DESIGN 1.3 8V Flex", "2022", "Flex", "Prata", "10000", "5600000","50000","5000",
		...
		ListaVeiculos.add(new Veiculo("Volkswagen - VW", "Fusca", "1985", "Flex", "Vermelha", "500000", "2700000","20000","1500",
		...
		ListaVeiculos.add(new Veiculo("Honda", "Civic Coupe Si 2.4 16V 206cv Mec. 2p", "2015", "Flex", "Cinza Claro",
